		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCustomAttributeAccess().getAlternatives_3(), "rule__CustomAttribute__Alternatives_3");
					put(grammarAccess.getRequiredAccess().getAlternatives(), "rule__Required__Alternatives");
					...
					put(grammarAccess.getCustomAttributeAccess().getGroup_3_1_2(), "rule__CustomAttribute__Group_3_1_2__0");
					put(grammarAccess.getGlobalsAccess().getGroup(), "rule__Globals__Group__0");
					...
					put(grammarAccess.getCharactersAccess().getGlobalsAssignment_2(), "rule__Characters__GlobalsAssignment_2");
					...
					put(grammarAccess.getTemplateAccess().getCustomsAssignment_4(), "rule__Template__CustomsAssignment_4");
					put(grammarAccess.getCustomAttributeAccess().getRequiredAssignment_0(), "rule__CustomAttribute__RequiredAssignment_0");
					put(grammarAccess.getCustomAttributeAccess().getCaNameAssignment_1(), "rule__CustomAttribute__CaNameAssignment_1");
					put(grammarAccess.getCustomAttributeAccess().getTypeAssignment_3_0(), "rule__CustomAttribute__TypeAssignment_3_0");
					put(grammarAccess.getCustomAttributeAccess().getEnumValuesAssignment_3_1_1(), "rule__CustomAttribute__EnumValuesAssignment_3_1_1");
					put(grammarAccess.getCustomAttributeAccess().getEnumValuesAssignment_3_1_2_1(), "rule__CustomAttribute__EnumValuesAssignment_3_1_2_1");
					...
					put(grammarAccess.getGlobalsAccess().getCustomsAssignment_2(), "rule__Globals__CustomsAssignment_2");
					put(grammarAccess.getGlobalsAccess().getCustomsAssignment_3(), "rule__Globals__CustomsAssignment_3");
