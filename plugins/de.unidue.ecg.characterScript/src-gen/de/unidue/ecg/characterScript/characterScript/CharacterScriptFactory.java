 ...
 * @generated
 */
public interface CharacterScriptFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  CharacterScriptFactory eINSTANCE = de.unidue.ecg.characterScript.characterScript.impl.CharacterScriptFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Custom Attribute Name</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Custom Attribute Name</em>'.
   * @generated
   */
  CustomAttributeName createCustomAttributeName();
  ...
  /**
   * Returns a new object of class '<em>Full Name</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Full Name</em>'.
   * @generated
   */
   ...
   * @generated
   */
  CharacterScriptPackage getCharacterScriptPackage();

} //CharacterScriptFactory
